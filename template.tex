...
The following gamma-ray analysis is based on the latest version of the FSSC Tools v11r5p3 [ref] and the fermipy package.
The dataset contains photon energies above 2 GeV and a time window between {{mjd1}}and {{mjd2}}
...
\centering
  ...
  \caption{{The TS Map of the region for MJD {{mjd1}}and {{mjd2}} and energies above {{energy}}GeV. The analysis model includes all the known sources from the 3FGL Catalog}}
\end{{figure}}

\begin{{figure}}[h!]
\centering
  \includegraphics[width=0.9\textwidth]{{{res_map}}}
  \caption{{The Residual Map of the region for MJD {{mjd1}}and {{mjd2}} and energies above {{energy}}GeV. The analysis model includes all the known sources from the 3FGL Catalog}}
\end{{figure}}
