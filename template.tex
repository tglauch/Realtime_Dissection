...
\fancyhead[L]{{
\includegraphics[width=3cm]{{/scratch9/tglauch/realtime_service/main/asi_logo.jpg}}
}}
\fancyhead[R]{{
\includegraphics[width=3cm]{{/scratch9/tglauch/realtime_service/main/ias_logo.jpg}}
}}
}}
...
\end{{subfigure}}
\caption{{Left: The residual test-statistic map of the region for a time window of 200 days (MJD {tsmjd1:.1f}, {tsmjd2:.1f}) around the
neutrino arrival time. Right: The redsidual test-statistic map of
the region for the entire \textit{{Fermi-LAT}} mission (MJD {mjd1:.1f} to {mjd2:.1f}). Both plots are done for energies above
{tsemin} GeV and shown after substracting known sources from the 4FGL catalog. That being said, the map can be used to
identify additional, yet, unkown gamma-ray emitters, that coincide with the multi-wavlength candidates. The blue circle indicates the 90\% error contouor from the neutrino alert. }}
\end{{figure}}
