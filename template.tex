...
neutrino \footnote{{{gcnurl}}},
\textit{{{event}}} (MJD: {date:.2f}), with direction ra: {ra:.2f}$^\circ$, dec: {dec:.2f}$^\circ$ in equatorial and l: {l:.2f}$^\circ$, b:
...
event. This report was generated autmoatically on {createdon}.
\end{{abstract}}
...
identify additional, yet unkown gamma-ray emitters, that coincide with multi-wavlength candidates. \textbf{{Left}}: The map of the region for a time window of 200 days (MJD {tsmjd1:.1f}, {tsmjd2:.1f}) around the
